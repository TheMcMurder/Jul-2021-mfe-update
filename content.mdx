...
# What will happen in RC-1?
- <Appear>Probably: 2-3 teams/projects will go first then expand</Appear>
- <Appear>Possible, but unlikely: RC-1 will be GA 1.0</Appear> 
...
- <Appear>RC 2?</Appear>
- <Appear>RC 3?</Appear>
- <Appear>Improved Dev tooling</Appear>

---

# More migrations?
- <Appear>RC 1 is MVP - we've had to move some code without improving it.</Appear>
- <Appear>Expect additional changes in the future</Appear>
- <Appear>Many MFE APIs are V1 - expect backwards compatible changes and deprecation cycles</Appear>
...
1. <Appear>Update projects to use latest Browserslist config</Appear>
