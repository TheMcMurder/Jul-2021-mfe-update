...
<img
  ...
  alt='This image acts as a sub-title, illustrating that the content below is discussing the pre-alpha stage of the migration'
/>
...
<img
  src={AlphaImage}
  className='mx-auto absolute inset-0 p-10'
  alt='This image acts as a sub-title, illustrating that the content below is discussing the alpha stage of the migration'
/>
...
- <Appear><InProgress>MFE React Spectrum</InProgress></Appear>
